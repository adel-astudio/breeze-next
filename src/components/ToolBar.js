...
function ToolBar({ pageSize }) {
    return (
        <div className="p-2 flex gap-x-2 divide-x">
            <Dropdown
                align="right"
                width="48"
                trigger={
                    <button className="flex items-center text-sm font-sans focus:outline-none transition duration-150 ease-in-out">
                        <div>{pageSize}</div>
                        <div className="ml-1">
                            <svg
